(function () {
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (!form || typeof window.atareao_ajax === 'undefined') {
            return; // guard
        }
        ...
        if (!messageEl) {
            ...
            if (respond) {
                respond.insertBefore(messageEl, respond.firstChild);
            }
        }
        ...
        document.addEventListener('click', function (e) {
            ...
            try {
                ...
                if (parentForName) {
                    ...
                    if (fn) {
                        authorName = (fn.textContent || fn.innerText || '').trim();
                    }
                }
            } catch (e) {
            }
        ...
        form.addEventListener('submit', function (e) {
            ...
            fetch((window.atareao_ajax && window.atareao_ajax.ajax_url) ? window.atareao_ajax.ajax_url : '/wp-admin/admin-ajax.php', {
                ...
                setTimeout(function () {
                    if (messageEl) {
                        messageEl.style.display = 'none'; } }, 6000);
            });
        });
    });
})();
