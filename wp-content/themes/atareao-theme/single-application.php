...
while (have_posts()) :
    ...
    the_post_navigation(array(
        'prev_text' => '<span class="nav-subtitle">' . __('Aplicación anterior:', 'atareao-theme') . '</span> <span class="nav-title">%title</span>',
        'next_text' => '<span class="nav-subtitle">' . __('Aplicación siguiente:', 'atareao-theme') . '</span> <span class="nav-title">%title</span>',
    ));
