    ...
    registerBlockType('atareao/podcast-player', {
        edit: function (props) {
            ...
            return el(
                ...
                el(
                    'div',
                    { className: 'atareao-podcast-player-editor' },
                    el(
                        'div',
                        { className: 'podcast-player-icon' },
                    ...
                    audioUrl ?
                        el(
                            'div',
                            { className: 'podcast-player-controls' },
                            el(
                                'audio',
                                {
                                    controls: true,
